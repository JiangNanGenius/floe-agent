...
Current TestFlight candidate: [Floe Agent 1.4.79 (Build 110) test notes](TESTFLIGHT_1.4.79.md). Availability must be confirmed from App Store Connect evidence.
