...
Current TestFlight candidate: [Floe Agent 1.4.80 (Build 111) test notes](TESTFLIGHT_1.4.80.md). Availability must be confirmed from App Store Connect evidence.
