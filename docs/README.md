...
Current TestFlight candidate: [Floe Agent 1.4.82 (Build 113) test notes](TESTFLIGHT_1.4.82.md). Availability must be confirmed from App Store Connect evidence.
