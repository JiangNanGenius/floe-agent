...
Current TestFlight candidate: [Floe Agent 1.4.83 (Build 114) test notes](TESTFLIGHT_1.4.83.md). Availability must be confirmed from App Store Connect evidence.
