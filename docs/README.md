...
Current TestFlight candidate: [Floe Agent 1.4.46 (Build 77) test notes](TESTFLIGHT_1.4.46.md). Availability must be confirmed from App Store Connect evidence.
