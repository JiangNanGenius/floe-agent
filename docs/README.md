...
Current TestFlight candidate: [Floe Agent 1.4.81 (Build 112) test notes](TESTFLIGHT_1.4.81.md). Availability must be confirmed from App Store Connect evidence.
