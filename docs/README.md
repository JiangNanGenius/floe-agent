...
Current TestFlight candidate: [Floe Agent 1.4.77 (Build 108) test notes](TESTFLIGHT_1.4.77.md). Availability must be confirmed from App Store Connect evidence.
