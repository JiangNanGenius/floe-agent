...
Current TestFlight candidate: [Floe Agent 1.4.74 (Build 105) test notes](TESTFLIGHT_1.4.74.md). Availability must be confirmed from App Store Connect evidence.
