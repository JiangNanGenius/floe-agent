...
Current TestFlight candidate: [Floe Agent 1.4.84 (Build 115) test notes](TESTFLIGHT_1.4.84.md). Availability must be confirmed from App Store Connect evidence.
