...
Current TestFlight candidate: [Floe Agent 1.4.85 (Build 116) test notes](TESTFLIGHT_1.4.85.md). Availability must be confirmed from App Store Connect evidence.
