...
Current TestFlight candidate: [Floe Agent 1.4.42 (Build 73) test notes](TESTFLIGHT_1.4.42.md). Availability must be confirmed from App Store Connect evidence.
