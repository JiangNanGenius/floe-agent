...
Current TestFlight candidate: [Floe Agent 1.4.45 (Build 76) test notes](TESTFLIGHT_1.4.45.md). Availability must be confirmed from App Store Connect evidence.
