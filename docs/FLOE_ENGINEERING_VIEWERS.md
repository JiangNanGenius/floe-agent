...
| STEP / IGES / BREP | occt-import-js 0.0.23 / Open CASCADE, bundled read only | Cube STEP, 10 mm cube IGES and BREP assembly render in wide/compact browser tests, with parsed part/face/unit information. Tessellation omits material colors and exact analytic surfaces. 384 MiB / 45-second worker, 200k triangle cap; App/device qualification pending. |
| FreeCAD FCStd | Not bundled | Export STEP/IGES or a mesh from FreeCAD. |
