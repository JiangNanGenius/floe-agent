...
当前内部测试版为 **1.7.0（218）/ beta.75**，已在私有 Floe QA TestFlight 可安装。9 月 21 日 15:08 UTC 已核实 Apple VALID、未过期及 IN_BETA_TESTING；匹配的 GitHub 开发者 IPA 和 Feather 源均已发布。本轮仅要求定向检查与云端验收 SDK 构建，真机行为仍由测试者验收。[交付记录](TESTFLIGHT_1.7.0_BETA.md) · [Build 218 说明](RELEASE_NOTES_1.7.0_BUILD_218.md)。
