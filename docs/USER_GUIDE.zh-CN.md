...
Build 214 已在内部 Floe QA TestFlight 可安装（9 月 20 日 21:32 UTC 核实 Apple VALID、未过期及 IN_BETA_TESTING），包含 TinyEMU/Linux 迁移及本轮全部反馈代码修复。[交付与真机验收范围](qualification/build214-release/README.md)。下方 Build 191/192 说明为历史记录。
