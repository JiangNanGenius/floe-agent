...
Build 214 已集成 TinyEMU/Linux 迁移和本轮全部反馈修复，云端打包及 TestFlight 交付仍在进行。请以 [Build 214 状态与验收范围](RELEASE_NOTES_1.7.0_BUILD_214.md)为准；下方 Build 191/192 说明是历史记录，不代表当前可安装版本。
