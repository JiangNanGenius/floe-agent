...
当前候选为 **1.7.0（150）/ `v1.7.0-beta.7` / `57f82f1`**；[云端发布运行 34746045819](https://github.com/JiangNanGenius/floe-agent/actions/runs/34746045819) 正在运行，尚无 Apple 上传成功证据。此前 149 被测试拦下。定向 150 执行 + 83 安全 + 12 工具权限测试通过，双端原生组件最新通过证据为 `4550b6d`。下文保留历史失败与修复过程，不能把早期“待确认”当作最新结论。
