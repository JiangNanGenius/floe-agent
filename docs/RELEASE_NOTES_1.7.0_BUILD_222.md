# Floe 1.7.0 (222) — TinyEMU Runtime v2 与专项修复 / TinyEMU Runtime v2 and focused repairs

Status: release candidate. This document describes source at the immutable Build
222 tag. Cloud build, TestFlight upload, Apple processing, Floe QA availability,
GitHub prerelease publication and physical-device acceptance are recorded only
after each result is obtained.

## 简体中文

Build 222 将本地 Linux 从“会话拥有一份完整运行盘”升级为持久 Environment 与
...
Build 222 separates persistent Linux environments from temporary TinyEMU VM
