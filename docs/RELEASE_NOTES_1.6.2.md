...
- 内置 28 族可商用中文字体（思源黑体/宋体简繁、霞鹜文楷、HarmonyOS Sans、MiSans、阿里巴巴普惠体、更纱黑体等），Office 预览/编辑的中文不再显示方框；同一套字体同时注册进系统文字管线，新建 Office 文档默认东亚字体改为思源黑体。
...
- Bundle 28 commercially usable Chinese font families (Source Han Sans/Serif SC+TC, LXGW WenKai, HarmonyOS Sans, MiSans, Alibaba PuHuiTi, Sarasa Mono and more). Office preview/editing no longer shows boxes for CJK text; the same set registers into the system text pipeline, and new Office documents default to Source Han Sans SC for East Asian text.
