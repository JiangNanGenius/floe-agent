...
**Distribution channels are separate.** GitHub has the Build 229 prerelease and unsigned IPA; Apple validation and Floe QA group verification have passed. Gitee source/tag and small-asset mirroring runs asynchronously. Its earlier 1 GiB repository attachment quota prevented mirroring the large Build 228 IPA; the Build 229 mirror outcome is tracked separately from TestFlight.
