...
The [build 175 repair is under validation](docs/FLOE_172_REPAIR_EXECUTION.md): Notes assistant conversations now have durable ownership and stay out of ordinary chat lists and search. Source `431e281d` passed 172/172 full-App regressions, while its iPad Notes UI timed out. Build 175 also repairs empty tool-call ID continuation fragments observed in a real Ark DeepSeek response. [Original evidence](docs/evidence/floe-1.7/build172-repair/app-431e281d.json) and failures remain recorded; no new repair TestFlight build has been uploaded yet.
