...
- **Edit code in a native workbench.** The IDE uses native SwiftUI/UIKit for its activity bar, file/search/Git sidebars, editor tabs, text and code editing, terminal panel and status bar. There is no Web text editor switch. The native editor supports multiple buffers, line numbers, bounded highlighting, find/replace, undo/redo, code-text zoom and conflict-safe saving; Markdown adds an outline, formatting controls and native preview over the same draft. The cloud App compile passed, but the targeted IDE UI check found a terminal-panel accessibility failure and is being rerun after a focused fix. The new workbench is not in delivered Build 225 or yet accepted on a physical device.
...
| Current status | [Build 225 delivery](docs/RELEASE_NOTES_1.7.0_BUILD_225.md) · [Build 226 candidate](docs/RELEASE_NOTES_1.7.0_BUILD_226.md) | [Build 225 交付](docs/RELEASE_NOTES_1.7.0_BUILD_225.md) · [Build 226 候选](docs/RELEASE_NOTES_1.7.0_BUILD_226.md) |
