...
struct CryptoCipherToolTests {
    ...
    func cloudWorkspaceSchemas() throws {
        let tools: [(String, String, [String], [String])] = [
            ...
            ("cloudWorkspace.git.status", CloudWorkspaceGitStatusTool.parametersJSON, ["workspaceID"], ["message", "name", "path"]),
            ("cloudWorkspace.git.diff", CloudWorkspaceGitDiffTool.parametersJSON, ["workspaceID", "path"], ["message", "name"]),
            ("cloudWorkspace.git.log", CloudWorkspaceGitLogTool.parametersJSON, ["workspaceID"], ["message", "name", "path"]),
            ("cloudWorkspace.git.fetch", CloudWorkspaceGitFetchTool.parametersJSON, ["workspaceID"], ["message", "name", "path"]),
            ("cloudWorkspace.git.stage", CloudWorkspaceGitStageTool.parametersJSON, ["workspaceID", "path"], ["message", "name"]),
            ("cloudWorkspace.git.initialize", CloudWorkspaceGitInitializeTool.parametersJSON, ["workspaceID"], ["message", "name", "path"]),
            ("cloudWorkspace.git.pull", CloudWorkspaceGitPullTool.parametersJSON, ["workspaceID"], ["message", "name", "path"]),
            ("cloudWorkspace.git.push", CloudWorkspaceGitPushTool.parametersJSON, ["workspaceID"], ["message", "name", "path"]),
            ("cloudWorkspace.git.commit", CloudWorkspaceGitCommitTool.parametersJSON, ["workspaceID", "message"], ["name", "path"]),
        ]
