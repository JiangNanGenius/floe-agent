...
public struct EngineConfiguration: Sendable {
    ...
    /// Floe: cooperative budget check, called inside the token dispatch loop.
    public var executionCheck: (@Sendable () throws -> Void)?
    ...
    public init(
        ...
        stackSize: Int? = nil,
        executionCheck: (@Sendable () throws -> Void)? = nil,
