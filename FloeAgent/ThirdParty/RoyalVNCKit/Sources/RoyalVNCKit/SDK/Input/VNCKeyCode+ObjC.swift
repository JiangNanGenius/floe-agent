...
public final class _ObjC_VNCKeyCode: NSObject {
    ...
    @objc
    public static let ansiKeypadClear = X11KeySymbols.XK_Clear // gitleaks:allow -- public X11 keyboard symbol, not a credential
    @objc
    public static let ansiKeypadEquals = X11KeySymbols.XK_KP_Equal // gitleaks:allow -- public X11 keyboard symbol, not a credential
    @objc
    public static let ansiKeypadDivide = X11KeySymbols.XK_KP_Divide // gitleaks:allow -- public X11 keyboard symbol, not a credential
    @objc
    public static let ansiKeypadMultiply = X11KeySymbols.XK_KP_Multiply
    @objc
    public static let ansiKeypadMinus = X11KeySymbols.XK_KP_Subtract // gitleaks:allow -- public X11 keyboard symbol, not a credential
    @objc
    public static let ansiKeypadPlus = X11KeySymbols.XK_KP_Add // gitleaks:allow -- public X11 keyboard symbol, not a credential
    @objc
    public static let ansiKeypadEnter = X11KeySymbols.XK_KP_Enter // gitleaks:allow -- public X11 keyboard symbol, not a credential
    @objc
