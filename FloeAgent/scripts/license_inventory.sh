...
rows.extend([
    ...
    ("lxml iOS", "6.1.3", "BSD-3-Clause, PSF-2.0 and bundled notices", "https://github.com/JiangNanGenius/floe-agent/releases/tag/runtime-lxml-6.1.3-cp313"),
    ("libxml2 (lxml static dependency)", "2.14.6", "MIT and bundled notices", "https://gitlab.gnome.org/GNOME/libxml2"),
    ("libxslt/libexslt (lxml static dependency)", "1.1.45", "MIT and bundled notices", "https://gitlab.gnome.org/GNOME/libxslt"),
