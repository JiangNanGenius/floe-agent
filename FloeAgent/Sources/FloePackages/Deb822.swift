...
public struct Deb822: Sendable, Equatable {
    ...
    public static func parse(stanza: String) -> Deb822 {
        var fields: [Field] = []
        ...
        flush()
        return Deb822(fields: fields)
    }

    /// Parses a multi-stanza document (Packages, Release, status).
    public static func parseAll(_ document: String) -> [Deb822] {
