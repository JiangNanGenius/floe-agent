...
public func registerExecutionTools(
    ...
    ToolCatalog.register(URLDownloadTool.self)
    ToolCatalog.register(CryptoHashTool.self, compatibilityOnly: true)
    ToolCatalog.register(SVGDocumentTool.self, compatibilityOnly: true)
    ToolCatalog.register(CryptoCipherTool.self)
    ToolCatalog.register(PDFFillFormTool.self)
    ...
    registry.register(NetworkTracerouteTool())
    registry.register(NetworkDNSLookupTool())
    registry.register(NetworkTCPProbeTool())
    registry.register(HTTPRequestTool(service: httpRequestService))
    registry.register(URLDownloadTool(service: httpRequestService))
    registry.register(CryptoHashTool(), compatibilityOnly: true)
