...
public enum RuntimeV2OfficialTemplatePinnedArtifacts {
    ...
    public static let all: [RuntimeV2OfficialTemplateArtifact] = [
        ...
        // The dev-document template was published as an immutable component
        // prerelease (floe-linux-template-dev-document-20260924.1) from the
        // unchanged, qualified image/templates run 35928029851; the complete
        // corresponding sources (Debian userland, kernel/bbl, relink toolchain
        // and the four pinned PyPI wheels with their PDFium source) come from
        // the retained run 35939078878 and are published in the same release.
        // Only `manifest.json` provenance was rewritten, so the final archive
        // digest differs from the image-build input while the disk bytes do
        // not. The App release pin is the tag target 3680d77a.
        RuntimeV2OfficialTemplateArtifact(
            templateID: "dev-document",
            version: 1,
            imageID: "floe-debian13-riscv64-202609202607-dev-document-rbe4a8d073352-b35928029851",
            archiveURL: "https://github.com/JiangNanGenius/floe-agent/releases/download/floe-linux-template-dev-document-20260924.1/floe-linux-guest-floe-debian13-riscv64-202609202607-dev-document-rbe4a8d073352-b35928029851.zip",
            archiveSHA512: "47f08bada308d64712724e3db5794396d2c11d13fec746dd8dfed2ec9e0de918564bcf61cfdb93eb9d6cd3d2ef1001b977232a3be04248b8d3cec8600c70aa13",
            archiveBytes: 1_077_342_227,
            diskSHA512: "fa969a4a685e8641bd81c703d338fb3c5b89bdfe081075db4544ff91664eea746e02ed408993aa4fbe4a0bd4fdf41548ad7f064ea937e264224b72f23af7ab38",
            recipeSHA512: "9901605761d1c2b75064a7cdb9244f13000c9e195a9316c7451c57448e62d8c5c5c850499e93d27aaa8b787dc9cd8d8f0d2b0458f0777334d45fd6e983e32145",
            recipeBase64: "",
            qualificationRunURL: "https://github.com/JiangNanGenius/floe-agent/actions/runs/35928029851",
            sourceRef: "3680d77a30bc251ca5b80db1b12c2a5529756f88"
        ),
    ]
}
