...
This directory contains the Swift package, generated Xcode project, native app, tests, and release scripts for the Floe Agent 1.4.26 source target (build 57). The minimum deployment target is iOS/iPadOS 26.0 and the current database schema is v20.
