...
**Current internal TestFlight: 1.7.0 (229)** (immutable tag `v1.7.0-beta.86`, source `b06b0b0e`). [Release run 36239956371](https://github.com/JiangNanGenius/floe-agent/actions/runs/36239956371) compiled with Xcode 26.6, retained the unsigned `Floe-Agent-1.7.0-build229-unsigned.ipa` (739,485,403 bytes; SHA-256 `5cd022eb612d89f1d94b91594b747000404cec3f247b8508e89a83e88436124d`) before signing, uploaded the signed build and published the matching GitHub prerelease. [Verify run 36242653374](https://github.com/JiangNanGenius/floe-agent/actions/runs/36242653374) confirmed Apple `VALID`, unexpired and `IN_BETA_TESTING` in the sole private Floe QA group; both beta-note languages were read back. Office close/save and unhealthy MLX container reuse have targeted source repairs, but PPT editable first frame/save/reopen, Office exit, local-model load/benchmark/multi-turn behavior and IDE Office tabs still require physical-iPad retesting. The two-core Linux launch path remains behind the one-core shipping gate after its guest qualification failed. [Delivery evidence](../docs/TESTFLIGHT_1.7.0_BETA.md).
